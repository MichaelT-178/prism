Prism.languages.fxml = {
    ...
    "fxml-red": {
        pattern: /VBox.margin|VBox|Label|Button|Insets|xml|import|DATABASE_URL|CLIENT_ID|CLIENT_SECRET|(?<!YOUR_|new_username )(USERNAME|PASSWORD)|USER_AGENT|SENDER_EMAIL|SENDER_PASSWORD|EMAIL_RECIPIENT|REFRESH_TOKEN|SPOTIFY_CLIENT_ID|SPOTIFY_CLIENT_SECRET|REDIRECT_URI|OPENAI_API_KEY|YOUTUBE_API_KEY|CHANNEL_ID|AUTH_CODE|DB_URL|DB_USERNAME|DB_PASSWORD|FLASK_ENV|DEV_DATABASE_URI|TEST_DATABASE_URI|PROD_DATABASE_URI|SPRING_ENV|JWT_SECRET_KEY/,
		lookbehind: true,
		alias: 'white',
		greedy: true
    },
