Prism.languages.fxml = {
    ...
    "fxml-red": {
        pattern: /VBox.margin|VBox|Label|Button|Insets|xml|import|DATABASE_URL|CLIENT_ID|CLIENT_SECRET|USERNAME|PASSWORD|USER_AGENT|SENDER_EMAIL|SENDER_PASSWORD|EMAIL_RECIPIENT|REFRESH_TOKEN|SPOTIFY_CLIENT_ID|SPOTIFY_CLIENT_SECRET|REDIRECT_URI|OPENAI_API_KEY|YOUTUBE_API_KEY|CHANNEL_ID|AUTH_CODE/,
		lookbehind: true,
		alias: 'white',
		greedy: true
    },
