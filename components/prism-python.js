Prism.languages.python = {
    ...
    'operator': /[-+%=]=?|!=|:=|\*\*?=?|\/\/?=?|<[<=>]?|>[=>]?|[&|^~]/,
    'punctuation': /[{}[\];(),.:](?!<\/span><span class="token format-spec">02<\/span>)/
};
