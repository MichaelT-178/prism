Prism.languages.javascript = Prism.languages.extend('clike', {
	...
	'gray-js': {
		pattern: /router(?=\s*=\s*)|router|(?<=class)=|:(?=\s*to)|display:|padding:|color:|background-color:|border:|border-radius:|text-align:|text-decoration:|App|font-size:|inline-block|<|font-family:|buttonText|App|:\s*\"path\"/,
		lookbehind: true,
		alias: 'red',
		greedy: true
	},
